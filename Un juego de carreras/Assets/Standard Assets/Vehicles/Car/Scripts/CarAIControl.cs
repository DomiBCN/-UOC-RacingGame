...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAIControl : MonoBehaviour
    {
        ...
        [HideInInspector] public bool m_Driving;                                                  // whether the AI is currently actively driving or stopped.
            ...
            if (m_Driving)
            {
                if (!replayRace)
                {
                    ...
                    if (!recording)
                    {
                        //START RECORDING
                        recording = true;
                        m_CarController.StartRecording();
                    }
                ...
                else
                {
                    ...
                    {
                        replaying = true;
                        m_CarController.StartReplay(raceData);
                    }
                }
            }
        }
        ...
        {
            m_CarController.SaveRace(time, gameObject.name);
        }
    }
}
